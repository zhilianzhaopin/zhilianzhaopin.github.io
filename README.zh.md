...
官方文件是建议安装bundler，这样你在本地的效果就跟在github上面是一样的。详情请见这里：https://help.github.com/articles/using-jekyll-with-pages/#installing-jekyll
...
我的博客标题是 **“Zhaopin Blog”** 但是我想要在搜索的时候显示 **“智联招聘的博客 | zhaopin Blog”** ，这个就需要SEO Title来定义了。
